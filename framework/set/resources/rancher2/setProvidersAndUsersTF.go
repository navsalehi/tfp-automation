...
func createRequiredProviders(rootBody *hclwrite.Body, configMap []map[string]any, customModule bool) {
	...
	source, rancherProviderVersion, cloudProviderVersion, linodeProviderVersion, localProviderVersion, rkeProviderVersion := getRequiredProviderVersions(configMap)
...
func createProvider(rootBody *hclwrite.Body, configMap []map[string]any, customModule bool) {
	_, _, cloudProviderVersion, linodeProviderVersion, _, _ := getRequiredProviderVersions(configMap)
...
func getRequiredProviderVersions(configMap []map[string]any) (source, rancherProviderVersion, rkeProviderVersion, localProviderVersion,
	cloudProviderVersion, linodeProviderVersion string) {
	...
	return source, rancherProviderVersion, cloudProviderVersion, linodeProviderVersion, localProviderVersion, rkeProviderVersion
}
